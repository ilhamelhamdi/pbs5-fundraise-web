...
export default function CardCampaignWrapper(props) {
    ...
    return (
        <Link href="/">
            <a className="card-campaign-wrapper w-60 flex-none md:w-6/20 md:flex-auto rounded-2xl bg-white block transform transition-all hover:-translate-y-2 mb-6 mr-4 shadow-lg text-sm lg:text-base">
